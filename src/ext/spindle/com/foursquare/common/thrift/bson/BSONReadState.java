...
public class BSONReadState {
  ...
  protected abstract static class ReadContext {
    ...
    abstract public Object getNextItem() throws TException;
    ...
    abstract public byte valueTType() throws TException;
  }
  ...
  private static class DocumentReadContext extends ReadContext {
    ...
    public byte valueTType() throws TException {
  ...
  protected static final TField NO_MORE_FIELDS = new TField("", TType.STOP, (short)0);
  ...
  protected static final byte UNKNOWN_TTYPE = TType.VOID;

  // Negative field ids are not allowed, so this will never be recognized by the generated code.
  protected static final short UNKNOWN_FIELD_ID = (short)-1;
